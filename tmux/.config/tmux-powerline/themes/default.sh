...
if [ -z "$TMUX_POWERLINE_LEFT_STATUS_SEGMENTS" ]; then
	TMUX_POWERLINE_LEFT_STATUS_SEGMENTS=(
		...
		#"ifstat 30 255"
		#"ifstat_sys 30 255"
		"lan_ip 30 255 ${TMUX_POWERLINE_SEPARATOR_RIGHT_THIN}"
...
if [ -z "$TMUX_POWERLINE_RIGHT_STATUS_SEGMENTS" ]; then
	TMUX_POWERLINE_RIGHT_STATUS_SEGMENTS=(
		...
		#"xkb_layout 125 117"
		"date_day 55 255"
		"date 56 255 ${TMUX_POWERLINE_SEPARATOR_LEFT_THIN}"
		"time 61 255 ${TMUX_POWERLINE_SEPARATOR_LEFT_THIN}"
