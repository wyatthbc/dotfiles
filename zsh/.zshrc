# Machine-specific startup output (e.g. fastfetch) must run BEFORE instant
# prompt, or p10k warns about console output on every shell. ~/.zshrc.pre.local
# is the early counterpart of ~/.zshrc.local and, like it, is not versioned.
